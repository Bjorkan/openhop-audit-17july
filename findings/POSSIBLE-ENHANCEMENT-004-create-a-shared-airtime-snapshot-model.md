# POSSIBLE-ENHANCEMENT-004 — Possible enhancement — create a shared airtime snapshot model
...
Airtime values are renamed and recomputed across AirtimeManager, engine stats, storage, Glass and dashboard code.
...
Return one immutable `AirtimeSnapshot` containing window duration, used ms, limit ms, actual duty percentage and budget percentage.
...
[Open `implementation_plan.md`](../implementation-plans/POSSIBLE-ENHANCEMENT-004/implementation_plan.md)
