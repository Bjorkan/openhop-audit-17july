# POSSIBLE-ENHANCEMENT-020 — implementation plan

[← Finding](../../findings/POSSIBLE-ENHANCEMENT-020-give-message-queue-entries-stable-identities-and-removal-by-token.md) · [← Audit index](../../README.md)

> This is a planning document, not a ready-to-apply patch. Revalidate line numbers and surrounding code against the branch being changed.

| Field | Value |
|---|---|
| Finding | **Possible enhancement — give message-queue entries stable identities and removal by token** |
...
Implement the maintainability improvement without changing unrelated behavior: Store entries with stable IDs and expose `peek/reserve/remove(id)` operations.
...
1. Wrap queued messages in entries with stable UUIDs/tokens and explicit lifecycle state.
2. Index/remove by identity rather than position or value equality.
3. Persist the identity and expose it in diagnostics without leaking payload content.
4. Test concurrent enqueue, persistence completion, retry and duplicate payloads.
